...
public class HistoryVO implements Serializable {
    ...
    private HistoryVO(Long id) { this.id = id; }

    public HistoryVO(Long id, String name, GenderEnum genderEnum, Date birth_date, String rg, String cnh,
                     Long cpf, String city, String address, String neighborhood, String residential_phone,
                     String cel_phone, String email, Date childbirth, String mothername, String mothercnh, String fathername,
                     String fathercnh, String namerep, String phonerep, String rgrep, UserStatusEnum statusEnum,
                     CredentialTypeEnum typeEnum, String comment, ActionEnum action, String changedat, Long lastchangeId) {
        this.id = id;
        this.name = name;
